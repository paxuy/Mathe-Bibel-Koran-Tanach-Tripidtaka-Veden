...
\begin{table}[H]
\begin{tabular}{@{}lc}
\multicolumn{2}{@{}c}{\textbf{Gleiche Wurzelexponenten}}\\
\rule{0pt}{1.5em}Multiplikation & $\sqrt[n]{a} \cdot \sqrt[n]{b} = \sqrt[n]{a \cdot b}$ \\
\rule{0pt}{1.5em}Division & $\dfrac{\sqrt[n]{a}}{\sqrt[n]{b}} = \sqrt[n]{\dfrac{a}{b}}$\\
\multicolumn{2}{@{}c}{\rule{0pt}{2em}\textbf{Unterschiedliche Wurzelexponenten}}\\
\rule{0pt}{1.5em}Potenzieren & $\left(\sqrt[n]{a}\right)^{m}=\sqrt[n]{a^{m}}$\\
\rule{0pt}{1.5em}Radizieren & $\sqrt[m]{\sqrt[n]{a}}=\sqrt[m\cdot n]{a}$\\
\end{tabular}
\end{table}
}{
\begin{table}[H]
\begin{tabular}{@{}lc}
\multicolumn{2}{@{}c}{\textbf{Gleiche Radikanden}}\\
\rule{0pt}{1.5em}Distributiv & $a\sqrt[n]{x} \pm b\sqrt[n]{x} = (a \pm b)\sqrt[n]{x}$ \\
\multicolumn{2}{@{}c}{\rule{0pt}{2em}\textbf{Besondere Wurzeln}}\\
\rule{0pt}{1.5em}& $\sqrt[1]{a}=a$\\
\rule{0pt}{1.5em}Quadratwurzel & $\sqrt[2]{a}=\sqrt{a}$\\
\rule{0pt}{1.5em}Kubikwurzel & $\sqrt[3]{a}$\\
\end{tabular}
\end{table}
}

\sidebysideB{\section{Summenzeichen}
\[\sum\limits_{i=1}^n a_i=a_1+a_2+\ldots+a_n\]
Beispiel:
\[\sum\limits_{i=0}^3 (2i+1)=1+3+5+7\]
}
{\section{Produktzeichen}
\[\prod\limits_{i=1}^n a_i=a_1+a_2+\ldots+a_n\]
Beispiel:%
\[\prod\limits_{i=1}^4 \frac{i}{i+1}=\frac{1}{2}\cdot\frac{2}{3}\cdot\frac{3}{4}\cdot\frac{4}{5}\]
}
